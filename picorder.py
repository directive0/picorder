...
def sliderScreen(surface,moire,tock,buttons,csvfile,rot,graphinit):
...
def graphScreen(surface,humidGraph,tempGraph,pressGraph,moire,tock,graphinit,buttons,csvfile,drawtock,rot):
      status = "graphgo"   
      drawinterval = 64
      senseinterval = 10
      #337
        ...
        try:
            ...
            while(status == "slidergo"):
                ...
                if key[pygame.K_q]:
                    ...
                    status = sliderScreen(surface,moire,tock,buttons,csvfile,rot,graphinit)
            ...
            while(status == "graphgo"):
                ...
                if key[pygame.K_q]:
                    ...
                    status = graphScreen(surface,humidGraph,tempGraph,pressGraph,moire,tock,graphinit,buttons,csvfile,drawtock,rot)
